...
## execute Rscript
Rscript ${DBSLMM} --summary ${summf}${chr}.assoc.txt --outPath ${outPath} --plink ${plink} --dbslmm ${dbslmm} --ref ${ref}${chr} --n ${n} --nsnp ${m} --type auto --model DBSLMM --block ${blockf}${chr}.bed --h2 ${h2} 
### Predict
